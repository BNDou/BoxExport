 ...
 * @LastEditTime : 2026-01-28 19:49:34
-->
...
- **日期格式优化**：自动将"出院时间"和"入院时间"格式化为纯日期格式（YYYY-MM-DD），去除时间部分。
...
- **日期格式处理**：程序会自动处理日期时间格式，将"2017-03-10 15:26:33"格式转换为纯日期"2017-03-10"，适用于Excel和PDF导出。
